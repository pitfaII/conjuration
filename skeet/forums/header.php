...
$tpl_main = str_replace('<pun_title>', '
			<h1><a href="index.php">game4<span>sense</span></a></h1>
			<div id="brddesc"><p><span>Get Good Get game4sense</span></p></div>
		', $tpl_main);
...
// New PMS
	...
	if($pun_user['g_id'] == 4){
	 $links[] = '<li id="premium"'.((PUN_ACTIVE_PAGE == 'premium') ? ' class="isactive"' : '').'><a class="usergroup-1" href="payment.php?game=csgo">Buy Game4Sense</a></li>';
	...
	if ($pun_user['is_admmod'])
			$links[] = '<li id="navadmin"'.((PUN_ACTIVE_PAGE == 'admin') ? ' class="isactive"' : '').'><a class="usergroup-1" href="admin_index.php">'.$lang_common['Admin'].'</a></li>';
